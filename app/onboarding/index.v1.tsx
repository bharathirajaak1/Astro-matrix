  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <Text style={styles.title}>Harmonize Your Cosmic Geometry</Text>
        <Text style={styles.description}>
          Unlock your natal Lo Shu 3x3 matrix, uncover hidden superpowers and blind spots, and practice daily micro-rituals tailored to your personal frequency.
        </Text>
